...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Новая форма возврата</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('sale_return.index') }}"> Назад</a>
            </div>
        </div>
    </div>
    @if (count($errors) > 0)
    ...
    @endif
    {!! Form::open(array('route' => 'sale_return.store','method'=>'POST','id'=>'form')) !!}
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Номер возвратa:</strong>
